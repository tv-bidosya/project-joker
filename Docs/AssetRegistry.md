...
| `Assets/UI/menu_card_salon_night_v2.png`, `Assets/UI/menu_card_salon_day_v3.png` | original paired main-menu backgrounds (PNG) | OpenAI ImageGen / Project Joker, 2026-08-14 | OpenAI Terms of Use — https://openai.com/policies/terms-of-use/ | да | да, night cards corrected with original Project Joker reference; day lighting variant derived from night and finished with subtle smoke above extinguished wicks | нет | не требуется | финальные промпты и происхождение в `Assets/UI/README.md` | готово |
